...
def get_common_error_messages() -> Dict[str, List[Dict[str, str]]]:
    ...
    return {
        "network": [
            {"error": "Connection refused", "message": "Could not connect to the server. Please check your internet connection."},
            {"error": "Timeout", "message": "The connection timed out. The server might be busy or unavailable."},
            {"error": "DNS resolution", "message": "Could not resolve the server's address. Check your internet connection."}
        ],
        "file_system": [
            {"error": "Permission denied", "message": "You don't have permission to access this file or directory."},
        ...
        "api": [
            {"error": "Invalid API key", "message": "The API key is invalid or has expired. Please update it in Settings."},
