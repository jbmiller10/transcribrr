...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Populate the recordings list with dummy data
        self.populate_recordings_list()

        # Button connections
        self.add_recording_button.clicked.connect(self.add_new_recording)
        self.recordings_list.itemClicked.connect(self.select_recording)
        self.save_button.clicked.connect(lambda: self.save_text_content(self.transcript_text, "Save Transcript"))
        self.settings_button.clicked.connect(self.open_settings_dialog)

        # Set the window to show maximized
        self.showMaximized()
    ...
    def add_new_recording(self):
        #logic to add a new recording
        pass

    # Method to handle the selection of a recording from the list
    def select_recording(self, item):
        #logic to handle what happens when a recording is selected
        pass
